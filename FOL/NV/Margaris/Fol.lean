...
theorem Forall_spec_id' (xs : List VarName) (P : Formula) (Δ : Set Formula)
...
theorem C_18_4 (U V : Formula) (P_U P_V : Formula) (Δ : Set Formula)
...
theorem T_18_7 (P_u P_v Q Q' : Formula) (u v : VarName) (Δ : Set Formula) (h1 : IsDeduct Δ Q)
